...
| <a name="input_ldap_vsi_osimage_name"></a> [ldap_vsi_osimage_name](#input_ldap_vsi_osimage_name) | Image name to use for provisioning the LDAP instances. Note: Debian based OS are only supported for the LDAP feature. | `string` |
...
| <a name="input_vpc_protocol_cluster_dns_domain"></a> [vpc_protocol_cluster_dns_domain](#input_vpc_protocol_cluster_dns_domain) | IBM Cloud DNS Services domain name to be used for the protocol nodes. | `string` |
