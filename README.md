...
| Name | Description |
|------|-------------|
| <a name="output_shematics_controller_ip"></a> [shematics_controller_ip](#output_shematics_controller_ip) | IP that has been used by the schematics side to ssh for bastion node to push the user input data file to create storage and compute cluster. |
