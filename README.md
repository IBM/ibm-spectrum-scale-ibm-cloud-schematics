...
| <a name="input_scale_encryption_vsi_osimage_name"></a> [scale_encryption_vsi_osimage_name](#input_scale_encryption_vsi_osimage_name) | Specify the image name to create the GKLM server when 'scale_encryption_type' is set to 'gklm'. Only RHEL 8.8 stock images are supported. | `string` |
